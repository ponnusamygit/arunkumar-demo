...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference("Computer.count") do
      post computers_url, params: { computer: { name: @computer.name, quantity: @computer.quantity } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { name: @computer.name, quantity: @computer.quantity } }
